...
if (istopv > 0.9){	
	...
	if ((mc_Entity.x == 37 || mc_Entity.x == 38)) {
			parm0 = 0.0041;
			parm1 = 0.005;
			parm2 = 0.0044;
			parm3 = 0.0038;
...
#ifdef WAVING_AETHER_FLOWERS
	if ((mc_Entity.x == 4069 || mc_Entity.x == 4070 || mc_Entity.x == 4065)) {
			parm0 = 0.0041;
			parm1 = 0.005;
			parm2 = 0.0044;
			parm3 = 0.0038;
...
#ifdef WAVING_LEAVES
	if ( mc_Entity.x == 18.0 || mc_Entity.x == 161) {
			parm0 = 0.0040;
			parm1 = 0.0064;
			parm2 = 0.0043;
			parm3 = 0.0035;
	...
	if (mc_Entity.x == 18 || mc_Entity.x == 106 || mc_Entity.x == 31 || mc_Entity.x == 37 || mc_Entity.x == 38 || mc_Entity.x == 59 || mc_Entity.x == 30.0 || mc_Entity.x == 115.0 || mc_Entity.x == 32.0)
